...
\subsection{Thrust Force \( \vec{T} \)}

\begin{itemize}
\item Direction: Along the rocket's longitudinal axis (body x-axis). 
\item Magnitude: Given by the rocket motor's thrust profile \( T(t) \).   
\end{itemize}
\end{document}